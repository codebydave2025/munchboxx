...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
    ...
    useEffect(() => {
        ...
        if (!auth && pathname !== '/admin/login') {
            ...
            // Smart Polling: Only poll when the window is focused/active
                                                ...
                                                >
                                                    ...
                                                    <div className={styles.notifText}>
                                                        ...
                                                        <span className={styles.notifDesc}>
                                                            Order <strong>#{order.id}</strong> by {order.customer.name}
                                                        </span>
                                                        <span className={styles.notifTime}>Total: ₦{order.total.toLocaleString()}</span>
                                                    </div>
                                                </Link>
                                            ))
                                        ) : (
